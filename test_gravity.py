...
class TestGravity(unittest.TestCase):
  def test_gravity_effect(self):
    self.assertEqual(gravity.gravity_effect(10000,Vector3f(1,1,1)),Vector3f(12.836420,12.836420,12.836420))
  ...
  def test_gravity_between_particles(self):
    ...
    self.assertEqual(res,Vector3f(12.836420,12.836420,12.836420))
  ...
  def test_gravity(self):
    ...
    self.assertEqual(a,Vector3f(12.836420,12.836420,12.836420))